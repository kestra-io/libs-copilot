...
public interface FlowYamlBuilder {
    @SystemMessage("""
        ...
        - Triggers initiate a Flow execution based on events or intervals, while tasks perform actions within a Flow. Always distinguish between them and include both as needed.
